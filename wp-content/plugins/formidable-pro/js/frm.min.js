...
if(null!==date)vals[field.valKey]=Math.floor(date.getTime()/864E5);else thisFullCalc=""}}}findVar="["+field.thisFieldId+"]";findVar=findVar.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");thisFullCalc=thisFullCalc.replace(new RegExp(findVar,"g"),vals[field.valKey])}return thisFullCalc}function tryToGetDateValue(field){var $element=jQuery(field.thisField.key);return $element.hasClass("hasDatepicker")?$element.datepicker("getDate"):null}function trimNumericCalculation(numericCalc){var lastChar=numericCalc.charAt(numericCalc.length-
